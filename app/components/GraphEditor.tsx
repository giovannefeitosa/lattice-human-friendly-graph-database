...
export default function GraphEditor() {
  ...
  if (exploreRootId) {
    return <GraphExplorer graph={graph} rootId={exploreRootId} onExit={() => setExploreRootId(null)} />;
  }
          ...
          <aside className="inspector" aria-label="Inspector de propriedades">
            ...
            {selectedNode && (
              <div className="form-stack" key={selectedNode.id}>
                ...
                <button className="wide explore-button" onClick={() => setExploreRootId(selectedNode.id)}>◎ Explorar a partir deste nó</button>
